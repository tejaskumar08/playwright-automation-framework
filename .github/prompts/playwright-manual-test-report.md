---
mode: agent
description: "Manually test a website and create a report"
...
2. Navigate to the url provided by the user and perform the described instructions. If no url is provided, ask the user to provide one.
...
4. Report back in clear, natural language:
   - What steps you performed (Navigation, interaction, assertions).
   - What you observed (outcome, UI changes, accessibility results).
